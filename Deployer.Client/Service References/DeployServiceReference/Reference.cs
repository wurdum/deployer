...
namespace Deployer.Client.DeployServiceReference {
    ...
    public interface IDeployService {
        ...
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, IsInitiating=false, Action="http://tempuri.org/IDeployService/Install")]
        void Install(Deployer.Client.DeployServiceReference.DeployContext context, byte[] files);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, IsInitiating=false, Action="http://tempuri.org/IDeployService/Update")]
        void Update(Deployer.Client.DeployServiceReference.DeployContext context, Deployer.Client.DeployServiceReference.DeployMode mode, byte[] files);
    }
    ...
    public partial class DeployServiceClient : System.ServiceModel.DuplexClientBase<Deployer.Client.DeployServiceReference.IDeployService>, Deployer.Client.DeployServiceReference.IDeployService {
        ...
        public void Install(Deployer.Client.DeployServiceReference.DeployContext context, byte[] files) {
            base.Channel.Install(context, files);
        }
        
        public void Update(Deployer.Client.DeployServiceReference.DeployContext context, Deployer.Client.DeployServiceReference.DeployMode mode, byte[] files) {
            base.Channel.Update(context, mode, files);
        }
    }
}
